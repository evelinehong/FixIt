...
from data_utils.classification_loader import FixItDataLoader
...
def main(args):
    ...
    train_dataset = FixItDataLoader(cat=args.cat, split='train', sample=True)
    test_dataset = FixItDataLoader(cat=args.cat, split='val', sample=True)
    ...
    classifier = model.get_model(2, normal_channel=False)
    ...
    for epoch in range(start_epoch, args.epoch):
        ...
        with torch.no_grad():
            ...
            savepath = str(checkpoints_dir) + '/%d.pth'%epoch
